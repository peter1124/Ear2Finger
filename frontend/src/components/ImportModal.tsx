...
export default function ImportModal({ isOpen, onClose, onSuccess, defaultPlaylistId }: ImportModalProps) {
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      setError(err.response?.data?.detail || 'Failed to import video')
      setStep('input')
        ...
        <div className="p-6">
            ...
            <>
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  disabled={isProcessing || !youtubeUrl.trim() || !selectedPlaylistId}
          ...
          {step === 'processing' && (
            <div className="text-center py-8">
              ...
              <p className="text-gray-700 font-medium">Processing video...</p>
              <p className="text-sm text-gray-500 mt-2">Downloading audio and extracting subtitles</p>
            </div>
          )}
          ...
          {step === 'success' && (
            <div className="text-center py-8">
              ...
              <p className="text-gray-700 font-medium">Video imported successfully!</p>
              <p className="text-sm text-gray-500 mt-2">Adding to playlist...</p>
            </div>
          )}
        </div>
      </div>
